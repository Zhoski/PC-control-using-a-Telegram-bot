This is a Telegram bot for managing PC files through Telegram. This bot works only with users whose ID is equal to ADMIN_ID, so replace ADMIN_ID with your own right away.
